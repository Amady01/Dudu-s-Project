...
**Critère :** Le MVP DOIT couvrir au lancement uniquement les **5 marques automobiles les plus représentées à Dakar** (Toyota, Peugeot, Hyundai, Nissan, Mitsubishi) et se concentrer sur les **10 pièces d'usure/courantes les plus recherchées** (amortisseurs, plaquettes de frein, filtres, phares, rétroviseurs, démarreurs, alternateurs, cardans, batteries, pompes à eau).
